export const analyzerScoreRating = 9;
/**
 *
 * @param {Jed} i18n
 * @constructor
 */
export function AnalyzerScoring(i18n) {
      ...
      scoreArray: [
        {
          type: "urlTooLong",
          score: 5,
          text: i18n.dgettext('js-text-analysis', "The slug for this page is a bit long, consider shortening it.")
        }
      ]
    }, {
